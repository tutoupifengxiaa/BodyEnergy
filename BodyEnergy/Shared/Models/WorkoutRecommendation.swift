...
struct WorkoutRecommendation: Equatable, Sendable {
    ...
    static let preview = WorkoutRecommendation(
        title: "二区有氧恢复跑",
        summary: "今天适合安排 20 到 30 分钟二区有氧，结束后加上 8 分钟拉伸放松。",
        durationText: "28 分钟",
        intensityText: "低到中等强度",
        purposeText: "维持心肺刺激，同时不过度消耗恢复储备。",
        cautionText: "如果心率持续偏高或主观疲劳明显，改成快走也可以。",
        steps: [
            "先做 5 分钟热身步行或动态活动，让心率逐步抬升。",
            "进入 18 分钟稳定二区有氧，保持可以完整说句子的呼吸节奏。",
    ...
    static func fallback(summary: String, energyScore: Int) -> WorkoutRecommendation {
        if energyScore >= 75 {
            return WorkoutRecommendation(
                ...
                intensityText: "中高强度",
                purposeText: "当前恢复较好，可承接更完整的训练安排。",
                cautionText: "如果热身后主观状态不佳，建议及时降强度。",
                steps: [
